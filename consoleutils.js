        ...
        /**
         * When a caseId is passed it retrieves the required information for processing.
         *
         *@params {String} caseId 
         *@returns {Promise} promise object with caseId and associated ContactId
         */
        ...
        /**
         * converts a 15digit sfId to 18digit salesforceId.
         *
         * @param {String} sfid
         * @returns {String} 
         */
         ...
         * @returns {Promise} Object with updateresults
         */
         ...
         * @returns {Promise} chat details with primaryTabId and success.
         */
         ...
         * @returns {Promise} Array of String of chatkeys.
         */
